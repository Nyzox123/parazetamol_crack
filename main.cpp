...
int main()
{
	...
	{
		xorstr_("C:\\parazetamolcrack\\"),
		xorstr_("C:\\parazetamolcrack\\dumps\\"),
		xorstr_("C:\\parazetamolcrack\\temp\\"),
		xorstr_("C:\\parazetamolcrack\\menus\\")
	};
	...
	SetConsoleTitle("Parazetamol Cracked By Nyzox#0258");
 ...
 |_|    \__,_||_|   \__,_|/___|\___| \__|\__,_||_| |_| |_| \___/ |_|                     
	...
	std::cout << xorstr_("Imagine getting cracked by Nyzox#0258") << std::endl;
	...
	std::cout << xorstr_("Waiting for process : FiveM.exe !..") << std::endl;
	...
	std::cout << xorstr_("Injected in FiveM.exe!") << std::endl;
